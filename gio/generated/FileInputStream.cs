...
#region Autogenerated code
	public class FileInputStream : GLib.InputStream, GLib.Seekable {
		...
		public void QueryInfoAsync(string attributes, int io_priority, GLib.Cancellable cancellable, GLib.AsyncReadyCallback cb) {
			...
			g_file_input_stream_query_info_async(Handle, GLib.Marshaller.StringToPtrGStrdup(attributes), io_priority, cancellable == null ? IntPtr.Zero : cancellable.Handle, cb_wrapper.NativeDelegate, IntPtr.Zero);
		}
		...
		public unsafe GLib.FileInfo QueryInfo(string attributes, GLib.Cancellable cancellable) {
			IntPtr error = IntPtr.Zero;
			IntPtr raw_ret = g_file_input_stream_query_info(Handle, GLib.Marshaller.StringToPtrGStrdup(attributes), cancellable == null ? IntPtr.Zero : cancellable.Handle, out error);
			GLib.FileInfo ret = GLib.Object.GetObject(raw_ret) as GLib.FileInfo;
			if (error != IntPtr.Zero) throw new GLib.GException (error);
			return ret;
		}
